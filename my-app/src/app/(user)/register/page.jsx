    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            if (resData.success) {
                ...
                alert("User registration failed: " + (resData.error || "Unknown error"));
            }
        } catch (error) {
            console.log(error);
    ...
    return (
        <section >
            ...
            <form onSubmit={handleRegister} className="flex flex-col gap-4 items-center w-[400px] m-auto  p-10 rounded-xl shadow-lg">
                ...
                <p className="text-lg text-gray-500">Already have an account? <Link href="/login" className=" text-orange-600 font-bold hover:underline">Login</Link></p>
            </form>
